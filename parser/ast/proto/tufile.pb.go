...
type IntAttr struct {
	LValue           *int64  `protobuf:"varint,1,req,name=LValue,json=lValue" json:"LValue,omitempty"`
...
func (m *IntAttr) GetLValue() int64 {
	if m != nil && m.LValue != nil {
		return *m.LValue
	}
	return 0
}
...
type Attr struct {
	...
	NumberedNodeRef  *NumberedNodeRef `protobuf:"bytes,29,opt,name=NumberedNodeRef,json=numberedNodeRef" json:"NumberedNodeRef,omitempty"`
	XXX_unrecognized []byte           `json:"-"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
