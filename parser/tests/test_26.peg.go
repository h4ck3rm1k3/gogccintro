...
func (p *GccNode) Init() {
	...
	_rules = [...]func() bool{
		nil,
		/* 0 NodeAttr <- <(ws (NodeFieldName / OpAttr) ws ':' ws <Node> ws Action0)> */
		func() bool {
			position0, tokenIndex0 := position, tokenIndex
			{
				...
				}
				{
					...
					{
						position4 := position
						add(ruleNodeFieldName, position4)
					}
					goto l2
